...
let RefreshableScrollView = class RefreshableScrollView extends ScrollView {
  ...
  renderRefreshHeader() {
    ...
    return <View style={[defaultHeaderStyles.header, this.props.refreshViewStyle]}>
        ...
        {this.props.displayDate && <Text style={[defaultHeaderStyles.date, this.props.dateStyle]}>{this.props.dateTitle + this.state.date}</Text>}
      </View>;
  }
  ...
  render() {
    return <ScrollView ref={c => this._scrollview = c} {...this.props} scrollEventThrottle={16} onScroll={this.onScroll} onScrollEndDrag={this.onScrollEndDrag} onScrollBeginDrag={this.onScrollBeginDrag}>
