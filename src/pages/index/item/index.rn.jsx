    ...
    return(
      <View className='list__item' key={index} onClick={this.onItemClick}>
        <View className='list__item-top' style={{height: coverHeight}}>
          <Image style={{resizeMode:'cover'}} className='list__item-top-cover' source={{uri:item.data.cover.detail}}/>
          ...
          <Image style={{resizeMode:'cover'}} className='list__item-top-titleMask' source={gradienBg}/>
        ...
        <View className='list__item-btm'>
          <View className='list__item-btm-avatar'><Image style={{resizeMode:'contain'}} className='list__item-btm-avatar-img' source={{uri:item.data.author.icon}}/></View>
